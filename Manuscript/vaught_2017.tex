...
\begin{abstract}
%The mass and energy of galactic winds remain poorly constrained via QSO and ``down-the-barrel" absorption line studies. One way to better constrain these %parameters is to measure the spatial extent of the outflow in emission. 
